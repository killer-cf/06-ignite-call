/*
  ...
  - You are about to drop the column `refresht_token` on the `accounts` table. All the data in the column will be lost.
...
INSERT INTO "new_accounts" ("access_token", "id", "provider_account_id", "user_id") SELECT "access_token", "id", "provider_account_id", "user_id" FROM "accounts";
DROP TABLE "accounts";
